...
/**
 *  \file       proceduretemplate_agenda.php
 *  \ingroup    procedure
 *  \brief      Tab of events on ProcedureTemplate
 */
...
$hookmanager->initHooks(array('proceduretemplateagenda', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($object->id > 0) {
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("ProcedureTemplate"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && (!empty($user->rights->agenda->myactions->read) || !empty($user->rights->agenda->allactions->read))) {
		...
		//print load_fiche_titre($langs->trans("ActionsOnProcedureTemplate"), '', '');
		print_barre_liste($langs->trans("ActionsOnProcedureTemplate"), 0, $_SERVER["PHP_SELF"], '', $sortfield, $sortorder, '', 0, -1, '', 0, $morehtmlright, '', 0, 1, 1);
