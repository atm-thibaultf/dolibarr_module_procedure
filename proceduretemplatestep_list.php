...
/**
 *   	\file       proceduretemplatestep_list.php
 *		\ingroup    procedure
 *		\brief      List page for proceduretemplatestep
 */
...
require_once __DIR__.'/class/proceduretemplatestep.class.php';
...
if ($enablepermissioncheck) {
	...
	$permissiontoadd = $user->hasRight('procedure', 'proceduretemplatestep', 'write');
	$permissiontodelete = $user->hasRight('procedure', 'proceduretemplatestep', 'delete');
} else {
	$permissiontoread = 1;
	$permissiontoadd = 1;
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'ProcedureTemplateStep';
	$objectlabel = 'ProcedureTemplateStep';
...
//$help_url = "EN:Module_ProcedureTemplateStep|FR:Module_ProcedureTemplateStep_FR|ES:Módulo_ProcedureTemplateStep";
$help_url = '';
$morejs = array();
$morecss = array();
