...
/**
 * \file    test/phpunit/ProcedureFunctionalTest.php
 * \ingroup procedure
 ...
 */
class ProcedureFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	private static $module_id = 104137; // TODO: autodetect?
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modProcedure')->click();
		} else {
			// Disable the module
			$this->byHref('modProcedure')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/procedure/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('procedure/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/procedure/admin/about.php');
		$this->authenticate();
		return $this->assertContains('procedure/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('procedurewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modProcedure_ProcedureTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modProcedure_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
