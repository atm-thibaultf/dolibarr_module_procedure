...
/**
 *  \file       proceduretemplate_contact.php
 *  \ingroup    procedure
 *  \brief      Tab for contacts linked to ProcedureTemplate
 */
...
$hookmanager->initHooks(array('proceduretemplatecontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($enablepermissioncheck) {
	...
	$permission = $user->rights->procedure->proceduretemplate->write;
} else {
	$permissiontoread = 1;
	$permission = 1;
}
...
$title = $langs->trans('ProcedureTemplate')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("ProcedureTemplate"), -1, $object->picto);
