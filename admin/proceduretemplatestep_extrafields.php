...
$langs->loadLangs(array('procedure@procedure', 'admin'));
...
$textobject = $langs->transnoentitiesnoconv("ProcedureTemplateStep");

$help_url = '';
$page_name = "ProcedureSetup";

llxHeader('', $langs->trans("ProcedureSetup"), $help_url);
