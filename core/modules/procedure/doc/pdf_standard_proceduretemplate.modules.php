...
/**
 *  \file       core/modules/procedure/doc/pdf_standard_proceduretemplate.modules.php
 *  \ingroup    procedure
...
/**
 *	Class to manage PDF template standard_proceduretemplate
 */
class pdf_standard_proceduretemplate extends ModelePDFProcedureTemplate
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_PROCEDURETEMPLATE_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->procedure->dir_output.'/proceduretemplate') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->procedure->dir_output.'/proceduretemplate';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->procedure->dir_output.'/proceduretemplate/'.$objectref;
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		if ($object->statut == $object::STATUS_DRAFT && getDolGlobalString('PROCEDURETEMPLATE_DRAFT_WATERMARK')) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('PROCEDURETEMPLATE_DRAFT_WATERMARK')));
		}
